...
from dreamid_omni.modules.t5 import T5EncoderModel
from dreamid_omni.modules.vae2_2 import Wan2_2_VAE
from dreamid_omni.modules.mmaudio.features_utils import FeaturesUtils
...
def init_fusion_score_model_ovi(rank: int = 0, meta_init=False):
    video_config = "dreamid_omni/configs/model/dit/video.json"
    audio_config = "dreamid_omni/configs/model/dit/audio.json"
